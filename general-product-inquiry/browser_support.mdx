...
This page only applies to the Agora Web SDK 3.x. If you use the Web SDK 4.x, see [Web SDK Compatibility](/realtime-communication/overview/supported-platforms?platform=web).
</Admonition>
...
The support for in-app browsers on mobile devices is complicated. For details, see [Supported Platforms](/realtime-communication/overview/supported-platforms).
...
- Safari does not support enabling [dual-stream mode](/realtime-communication/reference/glossary#dual-stream-mode).
...
[Supported Platforms](/realtime-communication/overview/supported-platforms)
