...
This page only applies to the Agora Web SDK 3.x. If you use the Web SDK 4.x, see [Web SDK Compatibility](/video-calling/overview/supported-platforms?platform=web).
</Admonition>
