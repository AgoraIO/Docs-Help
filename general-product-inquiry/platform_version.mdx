...
| Web          | See [Web SDK Compatibility](/realtime-communication/overview/supported-platforms)                                                                                                                  |
...
You can use RESTful APIs to enable and manage the Agora cloud recording services. See [Agora Cloud Recording RESTful API Quickstart](/cloud-recording/reference/restful-api) for details.
