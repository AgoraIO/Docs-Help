---
title: 'Which audio file formats does the Agora RTC SDK support?'
sidebar_position: 616 
category: 'NULL' 
platform: '["Voice","Video","Interactive Broadcast","live-streaming"]'
products: 'startAudioMixing, playEffect, audio track, format'   
description: '' 
...
<div class="alert note">For the extension library name for each platform, see <a href="./reduce_rtc_app_size">Reduce App Size</a >.</div>
