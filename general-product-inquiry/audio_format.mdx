---
title: 'Which audio file formats does the Agora <Vg k="VSDK" /> support?'
...
The Agora <Vg k="VSDK" /> provides a series of methods to manage audio files. The support of each method for single-track or multi-track audio files is as follows:
...
The Agora <Vg k="VSDK" /> supports single-track audio files in the following formats:
...
The Agora <Vg k="VSDK" /> supports multi-track audio files in the following formats:
...
<div class="alert note">
  ...
  <a href="../../integration-issues/reduce_app_size_rtc">Reduce App Size</a>.
</div>
