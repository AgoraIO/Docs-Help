...
### What should a user do if they get stuck frequently during class, can’t hear the audio clearly, have a white or black screen,
or fail to load courseware?
...
- Exit and re-enters the classroom or restart the device.
