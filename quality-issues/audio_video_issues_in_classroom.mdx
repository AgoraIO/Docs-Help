...
Adjust the resolution of class recordings in the web client by changing the recording state parameters in [RESTful API](../../flexible-classroom/restful-api/classroom-api#set-the-recording-state), specifically `webRecordConfig`:
