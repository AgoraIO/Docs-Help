...
- Check if the echo is occasional or continuous. An occasional echo may be caused by CPU overload. By using [Call Search](/agora-analytics/analyze/video-voice-sdk/call-search/) function of Agora Analytics, you can check the CPU usage on the **End-to-End Details** page.
