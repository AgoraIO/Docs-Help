...
- Check if the echo is occasional or continuous. An occasional echo may be caused by CPU overload. By using [Call Search](/agora-analytics/develop/call-inspector/call-search#analyze-quality-issues) function of Agora Analytics, you can check the CPU usage on the **End-to-End Details** page.
...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      <br />
      If the issue exists after the user causing or hearing the echo switches
      the audio route (such as using a headset).
    </td>
  </tr>
</table>
