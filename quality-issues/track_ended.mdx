...
- [Hot plugging of audio and video input devices (Web v4.x).](https://docs.agora.io/en/Interactive%20Broadcast/test_switch_device_web_ng?platform=Web#hot-plugging)