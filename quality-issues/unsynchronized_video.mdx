...
- If you use a custom video renderer, check the source code of the video renderer. See the [Customer renderer](/video-calling/develop/custom-video-and-audio) sample project provided by Agora for reference.
