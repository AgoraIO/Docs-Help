...
- If you use a custom video renderer, check the source code of the video renderer. See the [Customer renderer](/realtime-communication/advanced-features/custom-video#custom-video-rendering) sample project provided by Agora for reference.
