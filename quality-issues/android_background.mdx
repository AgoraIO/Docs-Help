...
Since Android 14, the Android system has restricted access to user data by background apps. See [Android behavior changes](https://developer.android.com/about/versions/pie/android-9.0-changes-all) for details.
