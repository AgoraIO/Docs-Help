...
2. Check if the camera access permission is enabled. Both Android and iOS have a runtime access permission function under System Settings. See [Add project permissions](/interactive-live-streaming/get-started/get-started-sdk#project-setup).
