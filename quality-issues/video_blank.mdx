...
3. Check whether the remote user uses the [channel encryption](/realtime-communication/advanced-features/media-stream-encryption) function but the local user doesn't.
