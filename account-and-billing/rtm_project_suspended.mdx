---
title: 'What Should I do If the DAU in My <Vg k="MESS" /> Project Exceeds 1000?'
...
If the number of daily active users (DAU) in your <Vg k="MESS" /> project exceeds 1,000, check whether you have registered with Agora and done any of the following:
