...
- The `fileList` field in the [`cloud_recording_file_infos`](https://docs.agora.io/en/cloud-recording/cloud_recording_callback_rest?platform=RESTful#a-name4a4-cloud_recording_file_infos) callback event