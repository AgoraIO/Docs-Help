...
- The `fileList` field in the responses of [`query`](/cloud-recording/reference/rest-api/query) and [`stop`](/cloud-recording/reference/rest-api/stop)
- The `fileList` field in the [`cloud_recording_file_infos`](/cloud-recording/reference/rest-api/rest-api-overview#4-cloud_recording_file_infos) callback event
