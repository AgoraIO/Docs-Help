...
This feature is in BETA. We recommend contacting support@agora.io before implementing this function.<p>The following products or features do not support string user accounts:
- <a href="https://docs.agora.io/en/cloud-recording/product_cloud_recording?platform=All%20Platforms">Cloud Recording</a >
- <a href="https://docs.agora.io/en/Interactive%20Broadcast/cdn_streaming_android?platform=Android">RTMP Converter</a >
- <a href="https://docs.agora.io/en/Video/rtc_channel_management_restfulapi?platform=RESTful">Channel Management RESTful API</a >
- <a href="https://docs.agora.io/en/Agora%20Platform/agora_console_restapi?platform=All%20Platforms">Console RESTful API</a ></p></div>
