...
- On-Premise Recording: [Individual Recording](/on-premise-recording/develop/individual-mode/) and [Composite Recording](/on-premise-recording/develop/composite-mode/).
- Cloud Recording: [Individual Recording](/cloud-recording/develop/individual-mode/) and [Composite Recording](/cloud-recording/develop/composite-mode/).
