...
- Uses only token-based authentication on all app clients to authenticate users. For details, see [Upgrade authentication mechanism](../../video-calling/develop/authentication-workflow).
