...
<Tabs groupId="sample-code-set-log-file">
...
<TabItem value="Objective-C" label="Objective-C">
<CodeBlock language="objc" showLineNumbers>
{`// Create AgoraLogConfig object
AgoraLogConfig *logConfig = [[AgoraLogConfig alloc] init];
// Set the log filter level to ERROR
...
// Set the log file size to 2MB
logConfig.fileSizeInKB = 2 * 1024;

// Create AgoraRtcEngineConfig object
