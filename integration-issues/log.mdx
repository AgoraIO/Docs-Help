...
// Initialize the Agora <Vg k="VSDK" /> engine context.
...
- Android
  - <Link to="{{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_initialize">`create`</Link>[2/2]
- iOS/macOS
...
- Windows
  - <Link to="{{Global.API_REF_WINDOWS_CSHARP_ROOT}}/class_irtcengine.html#api_create2">`initialize`</Link>
