...
| The user's gateway firewall disables the UDP protocol or the UDP ports greater than 10000.                    | Disable the firewall or use the [Agora Cloud Proxy](/voice-calling/develop/cloud-proxy) service. |
...
The type of candidates used for connection depends on whether you have enabled [cloud proxy](/voice-calling/develop/cloud-proxy) or not. Choose one of the following solutions accordingly.
