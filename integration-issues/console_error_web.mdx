...
| Reason | Solution    |
| :------------ | :----- |
| The web browser does not fully support WebRTC.  | Use a [Web browser](/realtime-communication/overview/supported-platforms?platform=web) supporting WebRTC. |
...
- Use a supported [Web browser](/realtime-communication/overview/supported-platforms).
