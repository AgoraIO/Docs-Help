...
- [RTM quickstart](/signaling/get-started/get-started-sdk)
- [RTM APIs for joining or leaving a channel](https://agora-api-reference.vercel.app/signaling-sdk/android/1.x/index.html#joinorleavechannel https://docs.agora.io/en/Real-time-Messaging/API%20Reference/RTM_java/index.html#joinorleavechannel)
