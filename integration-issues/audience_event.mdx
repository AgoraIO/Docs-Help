...
1. Enable the [message notification service](/video-calling/core-functionality/receive-notifications#enable-notifications).
...
- [Receive notifications about channel events](/video-calling/core-functionality/receive-notifications)	