...
- [Signaling quickstart](/signaling/get-started/get-started-sdk)
- <Link to="{{Global.SIG_SDK_API_ANDROID}}/index.html#joinorleavechannel">Signaling APIs for joining or leaving a channel</Link>
