...
After the token expires, you need to call the `logout` method to log out of the RTM system. Then, use the new token to create an RTM instance and call the `login` method to log in to the RTM system again.
