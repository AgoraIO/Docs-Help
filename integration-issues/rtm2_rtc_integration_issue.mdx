...
<Tabs>
  ...
  * **Windows**: Delete the earlier-version `libaosl.dll` file from the SDK package.
  ...
  ### Upgrade to Signaling SDK v2.2.2 or higher
    ...
    If you're using an Signaling SDK version earlier than 2.2.2, Agora recommends upgrading to v2.2.2 or later. Starting from this version, the Signaling SDK supports:
    ...
    <Tabs>
     <TabItem value="android" label="Android">
      ...
      1. Add the `aosl` dependency
          ...
          In your project’s root `build.gradle` file, add the following dependency:
