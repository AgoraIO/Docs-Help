...
When integrating Signaling SDK version 2.2.0 and above with <Vg k="VSDK" /> version 4.5.0 or higher, the following errors may appear in the IDE:
...
You can find the `aosl` library version for the SDKs in the [<Vg k="VSDK" />](/video-calling/overview/release-notes) or [<Vg k="ASDK" />](/voice-calling/overview/release-notes) release notes and [Signaling release notes](/signaling/overview/release-notes).
</Admonition>
