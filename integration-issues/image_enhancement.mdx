...
- Cocos Creator: <Link to="{{Global.API_REF_ROOT}}/cocos-creator/1.x/modules/agora.html?platform=Cocos%20Creator#setbeautyeffectoptions">`setBeautyEffectOptions`</Link>
