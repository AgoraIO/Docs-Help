...
- Android: <Link to="{{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_setbeautyeffectoptions">`setBeautyEffectOptions`</Link>
...
- Windows: <Link to="{{Global.API_REF_WINDOWS_CSHARP_ROOT}}/class_irtcengine.html#api_setbeautyeffectoptions">`setBeautyEffectOptions`</Link>

### Web

- Web 3.x: `setBeautyEffectOptions`
- Web 4.x: <Link to="{{Global.API_REF_WEB_ROOT}}/interfaces/beautyeffectoptions.html">`BeautyEffectOptions`</Link>

### Third-party frameworks developed from Native

- Electron: <Link to="{{Global.API_REF_ELECTRON_ROOT}}/class_irtcengine.html#api_irtcengine_setbeautyeffectoptions">`setBeautyEffectOptions`</Link>
- Unity: <Link to="{{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_setbeautyeffectoptions">`setBeautyEffectOptions`</Link>
- Flutter: <Link to="{{Global.API_REF_FLUTTER_ROOT}}/class_irtcengine.html#api_irtcengine_setbeautyeffectoptions">`setBeautyEffectOptions`</Link>
- React Native: <Link to="{{Global.API_REF_RN_ROOT}}/class_irtcengine.html#api_irtcengine_setbeautyeffectoptions">`setBeautyEffectOptions`</Link>
