...
1. Ensure that you have implemented basic real-time functions in your project. See [Realtime Communication Quickstart](/realtime-communication/get-started/get-started-sdk).
