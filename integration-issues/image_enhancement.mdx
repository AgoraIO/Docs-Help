...
- iOS: <Link to="{{Global.API_REF_IOS_ROOT}}/class_irtcengine.html#api_irtcengine_setbeautyeffectoptions">`setBeautyEffectOptions`</Link>
- macOS: <Link to="{{Global.API_REF_MACOS_ROOT}}/class_irtcengine.html#api_irtcengine_setbeautyeffectoptions">`setBeautyEffectOptions`</Link>
