...
category: 'NULL' 
platform: '["Video","Interactive Broadcast"]'
products: 'beauty, beauty effect, image enhancement'   
description: '' 
...
<li>Android: <code>libagora_video_process_extension.so</code></li>
<li>iOS: <code>AgoraVideoProcessExtension.xcframework</code></li>
<li>macOS: <code>AgoraVideoProcessExtension.framework</code> or <code>AgoraVideoProcessExtension.xcframework</code></li>
