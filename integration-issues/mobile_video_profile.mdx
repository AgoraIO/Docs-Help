...
<Tabs>
<TabItem value="tab1" label="Apple" default>
...
<TabItem value="tab2" label="Huawei"> 
...
<TabItem value="tab3" label="Xiaomi"> 
...
<TabItem value="tab4" label="Google"> 
...
<TabItem value="tab5" label="Samsung" default>
...
<TabItem value="tab6" label="Other">
