...
### Automatic Import
Since version 4.3.1, the <Vg k="VSDK" /> has automatically added the privacy manifest, so manual addition is not required. You can upgrade the SDK to this version to achieve automatic import of the privacy manifest. See the v4.3.1 release notes for details.
